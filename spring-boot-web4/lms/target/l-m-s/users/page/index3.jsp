...
<div class="pageContainer">
     ...
     <div class="pageSidebar">
         <ul class="nav nav-stacked nav-pills">
             <li role="presentation">
                 <a href="${APP_PATH}/users/page/car2.jsp" target="mainFrame">车辆信息查看</a>
             </li>
             <li role="presentation">
                 <a href="${APP_PATH}/users/page/route2.jsp" target="mainFrame">线路信息查看</a>
             </li>
             <li class="dropdown">
                 ...
                 <ul class="dropdown-menu">
                     <li>
                         <a href="${APP_PATH}/users/page/orst2.jsp" target="mainFrame">订单情况信息查看</a>
                     </li>
                     <li>
                         <a href="${APP_PATH}/users/page/orderG2.jsp" target="mainFrame">订单详细信息查看</a>
                     </li>
                 </ul>
             </li>
             <li role="presentation">
                 <a href="${APP_PATH}/users/page/storehouse2.jsp" target="mainFrame">仓库管理</a>
             </li>
             <!-- 开始 -->
             <li class="dropdown">
                 <a class="dropdown-toggle" data-toggle="dropdown" href="nav4.html" target="mainFrame">
